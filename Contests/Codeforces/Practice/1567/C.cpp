...
intt main()
{
  ...
  test(t)
  {
    ...
    fr(x,0,m)
    {
      ...
      {
        vals[k]+=(s[k]-'0');
        if((1LL<<k)&x) vals[k] -= 1, vals[k+2] += 10;
        curr *= ch[vals[k]];
      }
      ans += curr;
    }
...
// void iterative_traversal(Node* head)
// {
...
//     {
//       // PREORDER HERE
//       cout << "Preorder " << curr->data << endl;
//       st.push(make_pair(curr, count+1));
//       st.push(make_pair(curr->left, 0));
//     }
//     else if(count==1)
//     {
//       //  INORDER HERE
...
//       st.push(make_pair(curr, count+1));
//       st.push(make_pair(curr->right, 0));
//     }
//     else
//     {
//       // POSTORDER HERE
//       cout << "Postorder " << curr->data << endl;
//     }
//   }
// }
// int rec(int w)
// {
//   if(w==0) return 1;
//   return rec(w>>1) + w&1?rec((w+1)>>1):0;
// }
